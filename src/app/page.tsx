...
const Page = () => {
    ...
    return (
        ...
        >
            ...
            />
            {currentModelProps && <ModelViewer {...currentModelProps} resolutionPercentage={resolutionPercentage} setResolutionPercentage={setResolutionPercentage} showSettings={showSettings} dynamicResolution={false} targetFps={30} lowResScale={30} movementDebounce={500} />}
            <SwaroboLogo />
        </Application>
    );
};
